    ...
    <div className='LandingPage'>
      ...
      <div className="app-container-2-body">
        <div className="app-container-2-1">
          ...
          <div className="app-container-2-1-content">
            Login to add your daily tasks and make your tasklist so easier with
            GOGO app
          </div>
        ...
        <div className="app-container-2-2">
          ...
          >
            <path
              d="M623.82 147.059C547.89 159.812 403.34 232.309 432.579 420.274C461.817 608.238 337.383 699.64 271.511 721.845"
              stroke="url(#paint0_linear_106_40)"
              stroke-width="6"
            />
            <path
              d="M628.5 362.282C418.448 351.828 -0.719422 409.021 3.02492 721.415"
              stroke="url(#paint1_linear_106_40)"
              stroke-width="6"
            />
            <path
              d="M191.683 1C188.891 121.393 220.63 373.291 369.921 417.744C519.212 462.197 522.362 642.437 505.275 727"
              stroke="url(#paint2_linear_106_40)"
              stroke-width="6"
            />
            <defs>
              <linearGradient
                id="paint0_linear_106_40"
                x1="581.696"
                y1="168.538"
                x2="360.789"
                y2="653.244"
