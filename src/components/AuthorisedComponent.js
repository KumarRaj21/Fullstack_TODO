        ...
        <div className="App-right">
          <div className="app-right-head">
            <div className="app-right-head-1">
              <div className="app-right-head-1-1">
                Welcome{" "}
              ...
              <div className="app-right-head-1-2">
                ...
                {isdarkmode ? (
                  ...
                  >
                    <path
                      d="M10.0871 2.97744C10.373 2.30648 11.0636 1.83333 11.8703 1.83333C12.6769 1.83333 13.3676 2.30648 13.6535 2.97744C16.5066 3.72232 18.6034 6.21114 18.6034 9.16667V13.4725L20.3655 15.9915C20.5623 16.2728 20.5807 16.6345 20.4133 16.9325C20.2459 17.2306 19.92 17.4167 19.5652 17.4167H15.2027C14.9694 18.9715 13.5663 20.1667 11.8703 20.1667C10.1743 20.1667 8.77122 18.9715 8.53786 17.4167H4.17537C3.82064 17.4167 3.4947 17.2306 3.32732 16.9325C3.15993 16.6345 3.17828 16.2728 3.37505 15.9915L5.13723 13.4725V9.16667C5.13723 6.21114 7.23394 3.72232 10.0871 2.97744ZM10.5096 17.4167C10.7077 17.9507 11.2421 18.3333 11.8703 18.3333C12.4985 18.3333 13.0329 17.9507 13.231 17.4167H10.5096ZM11.8703 4.58333C9.21417 4.58333 7.06097 6.63536 7.06097 9.16667V13.75C7.06097 13.931 7.00476 14.1079 6.89942 14.2585L5.97263 15.5833H17.768L16.8412 14.2585C16.7358 14.1079 16.6796 13.931 16.6796 13.75V9.16667C16.6796 6.63536 14.5264 4.58333 11.8703 4.58333Z"
                      fill="#1C1D22"
                    />
                    <path
                      d="M18.1661 8.5C20.1579 8.5 21.814 6.9554 21.814 5C21.814 3.0446 20.1579 1.5 18.1661 1.5C16.1744 1.5 14.5182 3.0446 14.5182 5C14.5182 6.9554 16.1744 8.5 18.1661 8.5Z"
                      fill="#FFA048"
                      stroke="white"
                    />
                  </svg>
            ...
            <div className="app-right-head-2">
              <div className="app-right-head-2-1"></div>
          ...
          {/* <div className="app-right-body">
            <Routes>
              ...
              <Route
                path="/todo"
                element={<Todo tasklist={tasklist} settasklist={settasklist} />}
              />
              <Route
                path="/done"
